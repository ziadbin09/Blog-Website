    ...
    <>
      ...
      <section className="wrap" style={{ paddingBottom: 20 }}>
        <div className="grid-3">
          {[
            { slug:'galaxy-s25-ultra-review', tone:2, cat:'Smartphones', title:'Galaxy S25 Ultra: two months, one camera, no going back', excerpt:'Samsung\'s best phone ever? After two months of daily use, here\'s our verdict.', author:'Sarah Kim', read:'15 min' },
            { slug:'iphone-17-vs-pixel-9', tone:4, cat:'Reviews', title:'iPhone 17 vs Pixel 9 Pro: camera shootout that settles the debate', excerpt:'400 photos across 3 countries. The results might surprise you.', author:'Marcus Webb', read:'11 min' },
            { slug:'best-budget-android-2026', tone:3, cat:'Android', title:'Best budget Android phones under $200 in 2026', excerpt:'You don\'t need to spend $1,000 for a great Android experience.', author:'Priya Sharma', read:'9 min' },
    ...
    <>
      ...
      <section className="wrap section" style={{ paddingTop: 16 }}>
        <div className="with-side">
          <div>
            {[
              { slug:'android-16-features', tone:1, cat:'Android', title:'Android 16: the features that actually change how you use your phone', excerpt:'Google\'s biggest Android release in years. We tested every new feature across three weeks of daily use.', author:'Alex Chen', read:'12 min', date:'Jun 1, 2026' },
              { slug:'galaxy-s25-ultra-review', tone:2, cat:'Smartphones', title:'Galaxy S25 Ultra review: two months, one camera, no going back', excerpt:'After eight weeks of daily photography and demanding workloads, Samsung\'s Ultra still sets the benchmark.', author:'Sarah Kim', read:'15 min', date:'May 28, 2026' },
              { slug:'iphone-17-vs-pixel-9', tone:4, cat:'Reviews', title:'iPhone 17 vs Pixel 9 Pro: the camera shootout that settles the debate', excerpt:'400 photos, six lighting conditions, three countries. One camera wins — and it\'s not the one everyone expected.', author:'Marcus Webb', read:'11 min', date:'May 24, 2026' },
              { slug:'best-budget-android-2026', tone:3, cat:'Android', title:'Best budget Android phones under $200 in 2026', excerpt:'Great Android experiences no longer require a four-figure budget. These six phones prove the sub-$200 category has never been stronger.', author:'Priya Sharma', read:'9 min', date:'May 20, 2026' },
              { slug:'smartphone-battery-fix', tone:6, cat:'How-To', title:'Why your phone battery dies fast — and exactly how to fix it', excerpt:'Most battery drain problems trace back to four very fixable habits. Every setting, every app, every charging mistake covered.', author:'Alex Chen', read:'8 min', date:'May 17, 2026' },
              { slug:'chatgpt-mobile-tips', tone:5, cat:'AI & Mobile', title:'ChatGPT on mobile: the power features 90% of users never find', excerpt:'Hidden voice shortcuts, custom instructions, memory controls, and workflow hacks that make the app actually useful.', author:'Priya Sharma', read:'10 min', date:'May 13, 2026' },
              { slug:'wearables-2026', tone:2, cat:'Wearables', title:'Smartwatches in 2026: we tested every major model — here\'s who wins', excerpt:'Eight weeks. Six watches. Battery life is still the dealbreaker no spec sheet can hide. Here\'s which watch lasted.', author:'Zara Ahmed', read:'16 min', date:'May 9, 2026' },
              { slug:'android-malware-guide', tone:3, cat:'Cybersecurity', title:'How to spot and remove Android malware before it steals your data', excerpt:'Signs of infection, tools to clean your device, and the exact habits that prevent reinfection.', author:'James Carter', read:'13 min', date:'May 5, 2026' },
              { slug:'oneplus-13-camera', tone:1, cat:'Reviews', title:'OnePlus 13 camera deep-dive: flagship quality at half the price', excerpt:'OnePlus under-promises and over-delivers again. The 13 is their best camera yet — $300 less than the phones it beats.', author:'Sarah Kim', read:'14 min', date:'Apr 30, 2026' },
              { slug:'5g-explained', tone:4, cat:'Smartphones', title:'5G speeds decoded: what the numbers on your plan actually mean', excerpt:'Sub-6GHz, mmWave, and C-band explained without carrier marketing spin.', author:'Marcus Webb', read:'9 min', date:'Apr 25, 2026' },
              { slug:'best-android-apps-2026', tone:5, cat:'Apps & Software', title:'50 best Android apps of 2026 — tested, ranked, and actually useful', excerpt:'200 apps tested. 50 survived our ruthless cut. No filler, no sponsored picks.', author:'Priya Sharma', read:'16 min', date:'Apr 20, 2026' },
              { slug:'speed-up-android', tone:6, cat:'How-To', title:'How to make any Android phone feel new again in 10 minutes', excerpt:'Animation settings, background limits, battery optimisation, and the developer option that transforms slow phones.', author:'Alex Chen', read:'8 min', date:'Apr 15, 2026' },
              { slug:'foldables-worth-it', tone:1, cat:'Smartphones', title:'Foldable phones in 2026: we tested them all — here\'s who should buy one', excerpt:'After a full year living with three foldables, we know exactly who they\'re for.', author:'Marcus Webb', read:'11 min', date:'Apr 10, 2026' },
              { slug:'ios-19-hidden-features', tone:3, cat:'iOS', title:'iOS 19 hidden features: 14 things Apple didn\'t announce on stage', excerpt:'Buried in the iOS 19 update are 14 genuinely useful features Apple never mentioned. Here\'s where to find them.', author:'Sarah Kim', read:'13 min', date:'Apr 5, 2026' },
            ].map((p, i) => (
              <div key={p.title}>
      ...
      <section className="wrap section">
        ...
        <div className="grid-3">
          {[
            ...
            { slug:'iphone-17-vs-pixel-9', tone:4, cat:'Reviews', title:'iPhone 17 vs Pixel 9 Pro: the camera shootout', author:'Marcus Webb', read:'11 min' },
            { slug:'chatgpt-mobile-tips', tone:5, cat:'AI & Mobile', title:'ChatGPT on mobile: the power features you\'re missing', author:'Priya Sharma', read:'10 min' },
          ].map((r) => (
