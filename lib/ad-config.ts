...
export const IN_ARTICLE_SLOT: string | undefined = undefined;
...
export const IN_FEED: { slot: string; layoutKey: string } | undefined = undefined;

// Multiplex ad unit → Ads > By ad unit > Multiplex
export const MULTIPLEX_SLOT: string | undefined = undefined;
